export const cfg = {
  ...
  signalRHubUrl: process.env.SIGNALR_HUB_URL || process.env.POWERPLAY_LEADPOOL_HUB,
  cookiesPath: process.env.COOKIES_PATH || process.env.COOKIES_DIR || "/opt/render/project/src/cookies",
